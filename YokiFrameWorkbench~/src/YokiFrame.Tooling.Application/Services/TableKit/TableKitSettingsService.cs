...
public sealed class TableKitSettingsService
{
    ...
    private static TableKitOptions RebindLoadedOptions(string projectRoot, TableKitOptions options)
    {
        ...
        return options with
        {
            ...
            LubanAgentExecutablePath = ResolveOperationalPath(projectRoot, sourceRoot, options.LubanAgentExecutablePath),
            LubanMcpExecutablePath = ResolveOperationalPath(projectRoot, sourceRoot, options.LubanMcpExecutablePath),
            LubanSkillsPath = ResolveOperationalPath(projectRoot, sourceRoot, options.LubanSkillsPath),
    ...
    private static TableKitOptions CreatePortableOptions(string projectRoot, TableKitOptions options)
    {
        ...
        return options with
        {
            ...
            LubanAgentExecutablePath = RebaseStoredPath(projectRoot, sourceRoot, options.LubanAgentExecutablePath),
            LubanMcpExecutablePath = RebaseStoredPath(projectRoot, sourceRoot, options.LubanMcpExecutablePath),
            LubanSkillsPath = RebaseStoredPath(projectRoot, sourceRoot, options.LubanSkillsPath),
            OutputDataDir = RebaseStoredPath(projectRoot, sourceRoot, options.OutputDataDir),
            OutputCodeDir = RebaseStoredPath(projectRoot, sourceRoot, options.OutputCodeDir),
            EditorDataPath = RebaseStoredPath(projectRoot, sourceRoot, options.EditorDataPath),
            ExtraOutputTargets = RebaseExtraOutputs(projectRoot, sourceRoot, options.ExtraOutputTargets)
